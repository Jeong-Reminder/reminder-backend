...
public class AdminController {
    ...
    public ResponseDTO<Object> getMembers(Authentication authentication) {
        List<MemberAdminResponseDTO> memberAdminResponseDTOList = adminService.getMembers(authentication);
